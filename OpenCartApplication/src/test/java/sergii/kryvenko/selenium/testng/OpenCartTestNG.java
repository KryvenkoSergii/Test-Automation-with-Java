...
public class OpenCartTestNG extends OpenCartTestNGRunner {
    ...
    public void addItem(String nameItem) throws Exception {
     ...
     */
    @Test(dataProvider = "Data-Provider-Function")
    public void changeQuantityItemInCart(String nameItem) throws Exception {
...
//    @Test
    ...
    public void useCoupon(String couponCode) throws Exception {
...
//    @Test
    ...
    public void useCertificate(String certificateCode) throws Exception {
     ...
     */
//    @Test
    public void fillEstimateShipping() throws Exception {
...
//    @Test
    ...
    public void finishOrder(int waitTime) throws Exception {
        System.out.println(
        ...
        listCheckoutAccordion.put("Delivery Details", false); // displayed if
                                                              // exist iPhone!
